...
fn main() {
    ...
    // world.add_system(SystemSchedule::Update, test_system);

    // world.add_system(SystemSchedule::Update, test_system_1);

    world.add_systems(SystemSchedule::Update, (test_system, test_system_1));
